...
public class DrivetrainSubsystem extends SubsystemBase {
        ...
        public void periodic() {
                ...
                SmartDashboard.putNumber("Raw Gyro Yaw", m_gyro.getYaw().getValueAsDouble());
        ...
        public double getTurnRate() {
                return m_gyro.getAngularVelocityZWorld().getValueAsDouble() * (DriveConstants.DRIVE_KINEMATICS
                                .toSwerveModuleStates(new ChassisSpeeds(0, 0, 0)).length > 0 ? -1 : 1);
        }
}
